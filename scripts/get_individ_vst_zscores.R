...
dataset_name <- "tsoi_dt"  ### CHANGE THIS DEPENDING ON WHAT DATASET TO ANALYZE 
...
####################################### get log-space transformed expression values and z scores by gene
...
write.csv(df$vst_df, file = file.path("output", dataset_name, "vst.csv"), quote = TRUE)
write.csv(df$vst_df_z, file = file.path("output", dataset_name, "vst_zscores.csv"), quote = TRUE)
write.csv(df$vst_zscores_goi_noTFtargets, file = file.path("output", dataset_name, "vst_zscores_goi_noTFtargets.csv"), quote = TRUE)
write.csv(df$vst_zscores_goi_all, file = file.path("output", dataset_name, "vst_zscores_goi_all.csv"), quote = TRUE)
